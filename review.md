...
|---|---|---|---|---|
| R1 | Define the score + each oracle's contribution | §R1 below + weight-based `Wq` in the contract (K2.1) + contribution column in the UI | Kapilan (contract), Jeffrey (UI) | ⬜ |
